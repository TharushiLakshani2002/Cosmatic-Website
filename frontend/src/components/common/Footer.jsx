...
const Footer = () => {
    ...
    const footerLinks = {
        company: [
            ...
            {name: 'Shops', path: '/press'},
            {name: 'Blog', path: '/blog'}
        ],
        support: [
            {name: 'Contact Us', path: '/contact'},
            {name: 'FAQs', path: '/faqs'},
            {name: 'Shop Locator', path: '/locations'},
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-3xl font-bold">Fashion Hunt</span>
                        </div>
                        <p className="text-gray-400 mb-4 max-w-md">
                            Our go-to beauty destination. Offering premium skincare, top-quality cosmetics, and confidence-boosting essentials since 2025.
                        </p>
                        ...
                        <div className="mb-4">
                            ...
                            <form className="flex flex-col sm:flex-row gap-2">
                                <input
                                    ...
                                    className="flex-1 px-4 py-2 rounded-md bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
                                />
                                <button
                                    type="submit"
                                    className="px-6 py-2 bg-[#0fb8a1] text-white rounded-md hover:bg-green-700 transition-colors"
                                >
                                    Subscribe
                                </button>
                            </form>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="text-gray-400 mb-4 md:mb-0">
                        © {currentYear} Fashion Hunt. All rights reserved.
                    </div>
