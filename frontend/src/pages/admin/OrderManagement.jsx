...
import orderService from '../../services/orderService'; // Adjust the import path as necessary
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-white rounded-lg shadow p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Package className="w-8 h-8 text-[#0fb8a1]"/>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg shadow p-6">
                        <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 border rounded-md focus:ring-2 focus:ring-[#0fb8a1]"
                            />
                        </div>
                        <select
