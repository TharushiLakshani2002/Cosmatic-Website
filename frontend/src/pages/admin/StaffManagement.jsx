                        ...
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#0fb8a1] focus:border-transparent"
                                />
                            </div>
                        </div>
                        <select
                            ...
                            className="px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#0fb8a1] focus:border-transparent"
                        >
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    {editingUser === user._id ? (
                                                        <select
                                                            ...
                                                            className="text-sm rounded-md border-gray-300 focus:ring-brown-500 focus:border-[#0fb8a1]"
                                                            autoFocus
                                                        >
