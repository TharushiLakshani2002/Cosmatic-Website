                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white rounded-lg shadow p-6">
                                        ...
                                        <div className="grid grid-cols-3 gap-4">
                                            {[
                                                { value: 'in-store', label: 'In-Store Purchase', icon: '🛍️' },
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                <div className="md:col-span-2">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-[#0fb8a1]"
                                        ...
                                        <div className="border-t pt-3">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-[#0fb8a1]"
                                                />
                                    ...
                                    {!showCheckout ? (
                                        <>
                                            <button
                                                ...
                                                className="w-full py-3 bg-[#0fb8a1] text-white rounded-md font-medium hover:bg-[#0fb8a1] transition-colors"
                                            >
                                        ...
                                        <>
                                            <button
                                                ...
                                                disabled={loading}
                                                className="w-full py-3 bg-[#0fb8a1]text-white rounded-md font-medium hover:bg-[#0fb8a1] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                            >
                                                {loading ? (
                                                    <>
                                                        <div
